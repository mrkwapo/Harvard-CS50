// A bitmap file file named clue.bmp contains noisey red pixels that mask a message of who committed the crime. 
//This program copies the file but changes the red pixels before saving it into a new file. 
